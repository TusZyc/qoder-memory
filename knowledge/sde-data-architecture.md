...
> ⚠️ **本文档已被扩展** [Claude Code] 2026-04-10
> 范围更广的方案见 [`sde-first-architecture.md`](sde-first-architecture.md)，
> 它在本文档基础上加入了：
> - 把已有 26 个文件的 ESI 静态数据调用反向迁回 SDE 的迁移路径
> - 单一 `static.sqlite` 而非多子集
> - 管理后台 `/admin/sde` + ESI 兜底机制 + 国服差异覆盖表
> - Phase 0~4 灰度迁移计划
>
> **本文档保留有效**，作为装配模拟器/工业子集的具体表设计参考。
